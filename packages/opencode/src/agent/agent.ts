      ...
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        if (dllEnabled()) {
          ...
          agents.commander = {
            ...
            mode: "primary",
            native: true,
            model: Provider.parseModel("deepseek/deepseek-v4-pro"),
            prompt:
          ...
          agents["requirements-inspector"] = {
            ...
            mode: "subagent",
            native: true,
            model: Provider.parseModel("zai/glm-5.1"),
            steps: 6,
            prompt:
          ...
          agents["long-context-archivist"] = {
            ...
            mode: "subagent",
            native: true,
            model: Provider.parseModel("kimi/kimi-k2.6"),
            steps: 6,
            prompt:
          ...
          agents["final-auditor"] = {
            ...
            mode: "subagent",
            native: true,
            model: Provider.parseModel("openai/gpt-5.5-pro"),
            steps: 8,
            prompt:
