...
export const SKILL_REGISTRY: SkillDefinition[] = [
  ...
  },
  {
    ...
    verificationCommands: ["python3 -m py_compile /Users/dailulu/.local/bin/dll-agent", "python3 -m py_compile /Users/dailulu/.local/bin/dll-agent-quota", "dll-agent doctor"],
  ...
  },
  {
    ...
    verificationCommands: [
      ...
      "/Users/dailulu/.local/bin/dll-agent doctor",
      "git -C /Users/dailulu/projects/dll-agent-opencode diff --check",
    ],
